...
const texts: Record<Language, TextDefinitions> = {
	ja: {
		...
		mainMenuNavigation:
			"↑↓: 選択移動 | Enter: 決定 | 1-4: 直接選択 | ESC/q: 終了",
		...
		baselineFeatureNavigationInstructions:
			"↑↓: 選択 | Enter: 詳細表示 | ESC: 年選択に戻る",
		...
		recentBaselineNavigationInstructions:
			"↑↓: 選択 | Enter: 詳細表示 | ESC: 戻る",
	...
	en: {
		...
		mainMenuExit: "Exit",
		mainMenuNavigation:
			"↑↓: Navigate | Enter: Select | 1-4: Direct | ESC/q: Exit",
		...
		searchInstructions:
			"↑↓: Select | ←→: Page | / or s: Search | Enter: Confirm | ESC/q: Exit",
		searchInstructionsSearch:
			"Searching: ↑↓ to select | ←→ for page | Enter: confirm | ESC: end search",
		...
		baselineYearNavigationInstructions:
			"↑↓: Navigate | Enter: Select | ESC: Back",
		baselineFeatureNavigationInstructions:
			"↑↓: Navigate | Enter: Details | ESC: Back to year selection",
		baselineAvailableYears:
			"Available years (↑↓ to select, Enter to confirm): {0}/{1}",
		baselineYearCount: "{0} features",
		baselineScrollInstructions: "↑↓ keys to scroll (showing: {0}-{1})",
		baselineFeatureCount:
			"Feature list (↑↓ to select, Enter for details): {0}/{1}",
